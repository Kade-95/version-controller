...
var Repo = /** @class */ (function () {
    ...
    Object.defineProperty(Repo.prototype, "details", {
        get: function () {
            ...
            this.commitAncestory(commit).length + 1;
            var head = this.head;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        branch = { name: name, time: new Date(), commit: this.head.commit, _id: uuid.v4() };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, axios__namespace.default.get(url)];
                    case 1:
                        repo = (_a.sent()).data;
    ...
    Repo.insert = insertFunction;
    Repo.read = readFunction;
    Repo.update = updateFunction;
    Repo.delete = deleteFunction;
    return Repo;
}());

new Repo("Sample", null, function (repo) {
    console.log(repo);
});
